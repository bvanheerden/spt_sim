...
errs_gfp = np.loadtxt('errs_iscat_gfp2.txt')
errs_hiv = np.loadtxt('errs_iscat_hiv2.txt')
errs_lhcii = np.loadtxt('errs_iscat_lhcii2.txt')
...
plt.legend(ncol=2)
plt.tight_layout()
plt.savefig('./out/err_diff_iscat_art.png')
