...
plt.loglog(diffs, errs, '-o', label='Fluoressensie')
plt.loglog(diffs, errs_gfp, '-o', label='GFP')
plt.loglog(diffs, errs_lhcii, '-o', label="LHCII")
plt.loglog(diffs, errs_pb, '-o', label="FB")
plt.loglog(diffs, errs_lhcii_mic, '-o', label="LHCII-Misel")
plt.loglog(diffs, errs_hiv, '-o', label="MIV-QD")
