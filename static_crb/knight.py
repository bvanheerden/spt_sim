...
file_knight_100 = 'crb_lambda_knight_0.1'
file_knight_300 = 'crb_lambda_knight'
file_knight_500 = 'crb_lambda_knight_0.5'
file_knight_700 = 'crb_lambda_knight_0.7'
file_knight_900 = 'crb_lambda_knight_0.9'
...
# crb_lambda_knight = dill.load(fileobject_knight)
# crb700 = crb_lambda_knight(0, y, 400, 10000, 931, 1, 3000)
