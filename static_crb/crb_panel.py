...
ax3.set_yscale('log')
ax3.plot(y, crb300_kt, label='$L=300$ nm')
ax3.plot(y, crb500_kt, label='$L=500$ nm')
ax3.plot(y, crb700_kt, label='$L=700$ nm')
ax3.plot(y, crb900_kt, label='$L=900$ nm')
...
ax3.text(320, 13, '300', fontsize=10, color='C0')
ax3.text(320, 22, '500', fontsize=10, color='C1')
ax3.text(320, 31, '700', fontsize=10, color='C2')
ax3.text(320, 55, '900', fontsize=10, color='C3')

ax2.set_yscale('log')
ax2.plot(y, crb100_mf, label='$L=50$ nm')
ax2.plot(y, crb200_mf, label='$L=100$ nm')
ax2.plot(y, crb400_mf, label='$L=300$ nm')
ax2.plot(y, crb800_mf, label='$L=500$ nm')
ax2.plot(y, crb1600_mf, label='$L=700$ nm')
...
ax2.text(20, 1.7, '50', fontsize=10, color='C0')
ax2.text(35, 4, '100', fontsize=10, color='C1')
ax2.text(110, 7, '300', fontsize=10, color='C2')
ax2.text(180, 13, '500', fontsize=10, color='C3')
ax2.text(290, 20, '700', fontsize=10, color='C4')
