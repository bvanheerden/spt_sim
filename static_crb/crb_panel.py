...
ax2.text(320, 42, '700', fontsize=10, color='C2')
...
ax4.text(180, 8, 'KT 1500', fontsize=10, color='C0')
ax4.text(40, 2, 'MF 50', fontsize=10, color='C1')
ax4.text(200, 70, 'MF 566', fontsize=10, color='C2')
ax4.text(-400, 9, 'Orb 566', fontsize=10, color='C3')
...
ax5.text(370, 52, '900', fontsize=10, color='C3')
...
ax6.text(320, 41, '700', fontsize=10, color='C2')
ax6.text(320, 54, '900', fontsize=10, color='C3')
...
ax8.text(200, 70, 'MF 566', fontsize=10, color='C2')
ax8.text(-400, 9, 'Orb 566', fontsize=10, color='C3')
