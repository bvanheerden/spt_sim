...
ax1.text(340, 27, '700', fontsize=10, color='C2')
ax1.text(370, 43, '900', fontsize=10, color='C3')
...
ax2.text(-520, 50, 'b', fontweight='bold', fontsize='12')

ax2.text(320, 13, '300', fontsize=10, color='C0')
ax2.text(320, 22, '500', fontsize=10, color='C1')
ax2.text(320, 31, '700', fontsize=10, color='C2')
ax2.text(320, 55, '900', fontsize=10, color='C3')
...
ax3.text(-520, 2000, 'c', fontweight='bold', fontsize='12')
...
# ax4.text(200, 10, 'KT: $L=1500$ nm', fontsize=10, color='C0')
# ax4.text(100, 1000, 'MINFLUX: $L=50$ nm', fontsize=10, color='C1')
# ax4.text(200, 100, 'MINFLUX: $L=566$ nm', fontsize=10, color='C2')
# ax4.text(320, 55, 'Orbital: $L=566$ nm', fontsize=10, color='C3')
...
ax5.set_ylim(6, 80)
ax5.text(-520, 50, 'a', fontweight='bold', fontsize='12')

ax5.text(160, 12, '300', fontsize=10, color='C0')
ax5.text(230, 18, '500', fontsize=10, color='C1')
ax5.text(340, 27, '700', fontsize=10, color='C2')
ax5.text(370, 43, '900', fontsize=10, color='C3')
...
# ax3.legend(loc='lower right', framealpha=0.5, ncol=2, handlelength=1.0, labelspacing=0.3)
ax6.text(-520, 50, 'b', fontweight='bold', fontsize='12')

ax6.text(320, 13, '300', fontsize=10, color='C0')
ax6.text(320, 22, '500', fontsize=10, color='C1')
ax6.text(320, 31, '700', fontsize=10, color='C2')
ax6.text(320, 55, '900', fontsize=10, color='C3')
...
# ax2.legend(loc='upper center', framealpha=0.5, ncol=2, handlelength=1.0, labelspacing=0.3)
ax7.text(-520, 2000, 'c', fontweight='bold', fontsize='12')
ax7.set_xlabel('Position (nm)')
ax3.set_ylabel('CRB (nm)')

ax7.text(20, 1.7, '50', fontsize=10, color='C0')
...
# ax4.legend(loc='upper center', framealpha=0.5, handlelength=1.0, labelspacing=0.3)
ax8.text(-520, 2000, 'd', fontweight='bold', fontsize='12')
