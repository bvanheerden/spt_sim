...
crbknight = crb_lambda_knight(0, y, 50, 100, 400, 1,)
crbmf_large = crb_lambda_minflux(0, y, 500, 100, 800, 1)
crbmf = crb_lambda_minflux(0, y, 50, 100, 800, 1)
# crborb = crb_lambda_orbital(0, y, 566, 100, 400, 1)
crborb = crb_lambda_orbital(0, y, 500, 100, 353, 1)
...
plt.yscale('log')
plt.plot(y, crbknight, label="Knight's Tour L=1500")
plt.plot(y, crbmf, label='MINFLUX L=50')
plt.plot(y, crbmf_large, label='MINFLUX L=500')
plt.plot(y, crborb, label='Orbital L=500')
# plt.ylim(None, 100)
plt.legend(loc='lower right')
plt.xlabel('x (nm)')
plt.ylabel('CRB (nm)')
