...
simulation_orb = TrackingSim(numpoints=10000, method='orbital', freq=12.5, amp=4.0, waist=0.4, tracking=True,
...
err, measx, truex, kalmx, stagex, measy, truey, kalmy, stagey, intvals = simulation_orb.main_tracking(0.00000001)
