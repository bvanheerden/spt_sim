...
simulation_orb = TrackingSim(numpoints=100000, method='orbital', freq=2, amp=4.0, waist=0.4, tracking=True,
                             feedback=2, iscat=False, kalman=True, lqr=True)#, rin=0.1, weights=[0.1, 1, 1, 1])
