...
errs = np.loadtxt('files/desktop_pc/errs_fluo1.txt')
# errs_gfp = np.loadtxt('files/desktop_pc/errs_iscat_gfp2.txt')
# errs_hiv = np.loadtxt('files/desktop_pc/errs_iscat_hiv-qd2.txt')
# errs_lhcii = np.loadtxt('files/desktop_pc/errs_iscat_lhcii2.txt')
# errs_lhcii_mic = np.loadtxt('files/desktop_pc/errs_iscat_lhcii-mic2.txt')
# errs_pb = np.loadtxt('files/desktop_pc/errs_iscat_pb2.txt')
#
errs_gfp = np.loadtxt('files/desktop_pc/errs_iscat_gfp_adjust3.txt')
errs_lhcii = np.loadtxt('files/desktop_pc/errs_iscat_lhcii_adjust3.txt')
errs_lhcii_mic = np.loadtxt('files/desktop_pc/errs_iscat_lhcii-mic_adjust3.txt')
errs_pb = np.loadtxt('files/desktop_pc/errs_iscat_pb_adjust3.txt')
errs_hiv = np.loadtxt('files/desktop_pc/errs_iscat_hiv-qd_adjust3.txt')
