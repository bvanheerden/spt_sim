...
errs_gfp = np.loadtxt('files/errs_iscat_gfp_adjust_new.txt')
errs_lhcii = np.loadtxt('files/errs_iscat_lhcii_adjust_new.txt')
errs_lhcii_mic = np.loadtxt('files/errs_iscat_lhcii-mic_adjust_new.txt')
errs_pb = np.loadtxt('files/errs_iscat_pb_adjust_new.txt')
errs_hiv = np.loadtxt('files/errs_iscat_hiv-qd_adjust_new3.txt')
