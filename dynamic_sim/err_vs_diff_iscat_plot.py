...
errs = np.loadtxt('errs_fluo4.txt')
# errs_gfp = np.loadtxt('errs_iscat_gfp3.txt')
# errs_hiv = np.loadtxt('errs_iscat_hiv-qd3.txt')
...
errs_gfp = np.loadtxt('errs_iscat_gfp_adjust3.txt')
errs_lhcii = np.loadtxt('errs_iscat_lhcii_adjust4.txt')
errs_lhcii_mic = np.loadtxt('errs_iscat_lhcii-mic_adjust4.txt')
errs_pb = np.loadtxt('errs_iscat_pb_adjust4.txt')
errs_hiv = np.loadtxt('errs_iscat_hiv-qd_adjust4.txt')
