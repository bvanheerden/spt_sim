...
errs_lhcii_mic = np.loadtxt('errs_iscat_lhcii-mic4.txt')
errs_pb = np.loadtxt('errs_iscat_pb4.txt')
...
plt.xlabel(r'Diffusiekoëffisiënt (\textmu m$^2$s$^{-1}$)')
...
plt.legend(ncol=2)
plt.tight_layout()
plt.savefig('./out/err_diff_iscat2.pdf')
